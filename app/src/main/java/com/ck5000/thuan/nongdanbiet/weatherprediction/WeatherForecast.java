...
public class WeatherForecast extends ActionBarActivity {
    String q= "london";
    public static WeatherForecast it;
    @Override
    ...
    private void getWeatherDaily_Forecast() {
        ...
        Bundle packageFromCaller = callerIntent.getBundleExtra("ck5000");
        q =packageFromCaller.getString("location");
        WeatherAsyncTaskDaily_Forecast task = new WeatherAsyncTaskDaily_Forecast(it , this, q);
        task.execute();
    }
